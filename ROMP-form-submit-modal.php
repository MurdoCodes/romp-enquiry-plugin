<?php 
	...
	$postcode = $decoded[0]['value'];
	$county = $decoded[1]['value'];
	$postal_town = $decoded[2]['value'];
	$street_address1 = $decoded[3]['value'];
	$street_address2 = $decoded[4]['value'];
	$street_address3 = $decoded[5]['value'];
	$title = $decoded[6]['value'];
	$fname = $decoded[7]['value'];
	$sname = $decoded[8]['value'];
	$landline = $decoded[9]['value'];
	$mobile = $decoded[10]['value'];
	$email = $decoded[11]['value'];
